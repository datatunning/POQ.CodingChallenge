// <copyright file="ProductServiceTests.cs" company="Bruno DUVAL">
...
namespace POQ.CodingChallenge.API.UnitTests.Services
{
    ...
    public class ProductServiceTests
    {
        ...
        private readonly IList<MockyProduct> _mockyProducts = new List<MockyProduct>
        {
            new()
            {
                title = "A Red Trouser",
        ...
        public async Task ShouldReturnAllProductsWhenNoRequestFilter()
        {
            ...
            productStore.RealAll(ct).Returns(_mockyProducts);
            ...
            // Assert
            await productStore.Received().RealAll(ct);
            response.Products.Should().BeEquivalentTo(_mockyProducts);
        }
